...
interface ConvertersContext {
    ...
    fun registerConverter(visitorClass: Class<out ConvertersContextVisitor>)

    fun registerConverter(visitor: ConvertersContextVisitor)

    /**
     * Convert single object to another type.
     *
     * @param object   some object
     * @param token    token that will be passed in [IEntityConverter.convert] (Object, Object, ConvertersContext)} method.
